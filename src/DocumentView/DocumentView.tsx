...
export class DocumentView extends PureComponent<DocumentViewProps, any> {
  ...
  setStampImageData = (
    ...
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.setStampImageData(
        tag,
        annotationId,
        pageNumber,
        stampImageDataUrl
  ...
  setFormFieldHighlightColor = (
    fieldHighlightColor: AnnotOptions.ColorWithAlpha
  ): Promise<void> => {
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.setFormFieldHighlightColor(
        tag,
        fieldHighlightColor
      );
    }
  ...
  setFlagsForAnnotations = (
    ...
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.setFlagsForAnnotations(
        tag,
        annotationFlagList
      );
    }
  ...
  getPropertiesForAnnotation = (
    ...
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.getPropertiesForAnnotation(
        tag,
        id,
        pageNumber
      );
  ...
  setAnnotationToolbarItemEnabled = (
    ...
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.setAnnotationToolbarItemEnabled(
        tag,
        itemId,
        enable
      );
  ...
  addAnnotation = (
    ...
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.addAnnotation(
        tag,
        type,
        fieldName,
        pageNumber,
  ...
  appendPDFToDocument = (sourceDocPath: string): Promise<void> => {
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.appendPDFToDocument(tag, sourceDocPath);
    }
    return Promise.resolve();
  };

  setSignaturesHighlightColor = (
    signaturesHighlightColor: AnnotOptions.ColorWithAlpha
  ): Promise<void> => {
    const tag = findNodeHandle(this._viewerRef);
    if (tag != null) {
      return DocumentViewManager.setSignaturesHighlightColor(
        tag,
        signaturesHighlightColor
      );
    }
    return Promise.resolve();
  };
